...
## Purpose
Define the governed procedure for missing po exception handling in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches missing po exception handling or an exception related to that area is detected.
