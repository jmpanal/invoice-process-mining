...
## Purpose
Define the governed procedure for three-way match execution in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches three-way match execution or an exception related to that area is detected.
