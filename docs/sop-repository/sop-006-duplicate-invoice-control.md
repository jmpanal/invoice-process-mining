...
## Purpose
Define the governed procedure for duplicate invoice control in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches duplicate invoice control or an exception related to that area is detected.
