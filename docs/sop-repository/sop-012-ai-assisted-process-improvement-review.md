...
## Purpose
Define the governed procedure for ai-assisted process improvement review in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches ai-assisted process improvement review or an exception related to that area is detected.
