...
## Purpose
Define the governed procedure for price mismatch exception handling in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches price mismatch exception handling or an exception related to that area is detected.
