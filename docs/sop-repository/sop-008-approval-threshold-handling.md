...
## Purpose
Define the governed procedure for approval threshold handling in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches approval threshold handling or an exception related to that area is detected.
