...
## Purpose
Define the governed procedure for purchase order verification in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches purchase order verification or an exception related to that area is detected.
