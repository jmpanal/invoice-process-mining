...
## Purpose
Define the governed procedure for manual workaround prohibition in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches manual workaround prohibition or an exception related to that area is detected.
