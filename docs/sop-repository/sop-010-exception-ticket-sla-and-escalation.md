...
## Purpose
Define the governed procedure for exception ticket sla and escalation in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches exception ticket sla and escalation or an exception related to that area is detected.
