...
## Purpose
Define the governed procedure for vendor risk and compliance review in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches vendor risk and compliance review or an exception related to that area is detected.
