...
## Purpose
Define the governed procedure for payment scheduling and remittance in the invoice exception handling process.
...
## Trigger
The procedure starts when the process reaches payment scheduling and remittance or an exception related to that area is detected.
